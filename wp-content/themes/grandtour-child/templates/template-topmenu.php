...
<!-- Begin top bar -->
<div class="above_top_bar" id="custom-top-bar">
    ...
    <div class="top_contact_info">
		...
		<?php
		    ...
		    {
		?>
		    <span id="top_contact_number"><a href="tel:<?php echo esc_attr($tg_menu_contact_number); ?>">Call us now <?php echo esc_html($tg_menu_contact_number); ?></a></span>
		<?php
		    }
		?>
	    ...
	    <div id="menu_search">
		    <div class="menu_search_wrapper">
			    <form id="menu_search_form" class="searchform" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
			    	...
			    	<span><input type="text" class="field searchform-s" id="s" name="s" value="<?php the_search_query(); ?>" placeholder="<?php esc_html_e( 'Search', 'grandtour' ); ?>" autocomplete="off"></span>
...
<div class="top_bar <?php if(!empty($page_menu_transparent)) { ?>hasbg<?php } ?>">
    	...
    	<div id="logo_right_button">
			...
			<!-- <div class="header_cart_wrapper">
			    ...
			    <a href="<?php //echo esc_url($cart_url); ?>"><span class="ti-shopping-cart"></span></a>
			</div> -->
			<?php
			//}
			?>
