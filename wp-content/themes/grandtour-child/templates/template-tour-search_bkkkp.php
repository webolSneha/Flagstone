    	...
    	<div class="<?php if( !$checkSki ){ echo 'one_fourth'; }else{ echo 'one_fourth'; } ?> themeborder">
    		...
    		<select id="destination" name="dest">
	    		...
	    		<?php
		   			...
		   			}else if( wp_get_post_parent_id(get_the_ID()) == 0 ){
			    ?>
			    ...
			    <?php	
			    		...
			    		if( wp_get_post_parent_id(get_the_ID()) != $_GET['dest'] ){
			    			$country_html .=' style="display:none;" ';
			    		}
			    		$country_html .=' class="destination-id-'. wp_get_post_parent_id(get_the_ID()) .'"';
			    		if(isset($_GET['country']) && in_array(get_the_ID(),$arrcountry)){//$_GET['country']==get_the_ID()) {
			    		...
			    		// 	if( get_the_ID() == $_GET['country'] ){
			   			...
			   			if( wp_get_post_parent_id(get_the_ID()) != $_GET['country'] ){
			   				$resorts_html .=' style="display:none;" ';
			   			}
			   			$resorts_html .=' class="destination-id-'. wp_get_post_parent_id(get_the_ID()) .'"';
    		...
    		<select id="country" style="display: none;" multiple="multiple">				
